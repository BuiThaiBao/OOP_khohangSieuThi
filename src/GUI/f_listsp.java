 ...
 * @author phong
 */
public class f_listsp extends javax.swing.JFrame {

    /**
     * Creates new form f_listsp
     */
    public f_listsp() {
        initComponents();
        getListSP();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Sản Phẩm", "Tên Sản Phẩm", "Loại Sản Phẩm"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_listsp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
