 ...
 * @author Admin
 */
public class f_DSnhanvien extends javax.swing.JFrame {
    ...
    public void getLisNV(){
         DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
         String sql="select ID_NV, Ten_NV, SDT, CCCD, Ngay_Sinh from nhan_vien";
         int i=0;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_NV", "Tên Nhân viên", "Số điện thoại", "CCCD", "Ngày sinh"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_DSnhanvien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new f_DSnhanvien().setVisible(true);
            }
        });
    }
